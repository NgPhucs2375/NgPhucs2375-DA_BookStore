...
public class NotificationController {
    ...
    public UnreadCountResponse getUnreadCount(HttpServletRequest request) {
        Long userId = resolveCurrentUserId(request);
    ...
    public Map<String, Integer> markAllAsRead(HttpServletRequest request) {
        Long userId = resolveCurrentUserId(request);
    ...
    public org.springframework.web.servlet.mvc.method.annotation.SseEmitter subscribe(HttpServletRequest request) {
        Long userId = resolveCurrentUserId(request);
    ...
    @PostMapping("/admin")
    public com.example.bookstore.dto.NotificationItemResponse createByAdmin(HttpServletRequest request,
                                                                            @RequestBody com.example.bookstore.dto.NotificationCreateRequest req) {
        Long creatorUserId = resolveCurrentUserId(request);
